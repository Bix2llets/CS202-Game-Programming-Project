...
void WinningScreen::constructButtons() {
...
WinningScreen::WinningScreen(Mediator &mediator)
    : Overlay(mediator),
    ...
    message1.setString("The approaching zombies");
    ...
    message2.setString("are defeated");
...
WinningScreen::~WinningScreen() { buttons.clear(); }

bool WinningScreen::onMouseEvent(Mouse mouse, UserEvent event,
...
void WinningScreen::render() const {
